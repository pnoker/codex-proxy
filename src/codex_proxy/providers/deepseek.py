...
from .deepseek_stream import stream_responses_loop
...
class DeepSeekProvider(BaseProvider):
    ...
    def _execute_request(
        ...
        auth_header = (
            f"Bearer {config.deepseek_api_key}" if config.deepseek_api_key else None
        )
    ...
    def _write_mapped_response(self, resp: requests.Response, handler: Any) -> None:
        ...
        resp_obj = {
            "id": f"ds_{d_data.get('id')}",
            "object": "response",
            "created": d_data.get("created"),
